...
df = pd.read_csv('C:\\Users\\neumann\\Documents\\projects\\get\\restaurantes_fortaleza.csv')  # Substitua 'enderecos.csv' pelo nome do seu arquivo CSV
...
df[['Nome', 'Latitude', 'Longitude']].to_csv('C:\\Users\\neumann\\Documents\\projects\\get\\restaurantes_position.csv', index=False)
